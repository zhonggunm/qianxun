/**
 * Created by yshaoxp on 2017/2/2.
 */

export function qrcode (h) {
  var s;
  ...
  o.prototype = {
    addData: function (a) {
      ...
      if (a < 0 || this.moduleCount <= a || c < 0 || this.moduleCount <= c) {
        throw Error(a + ',' + c);
      }
    ...
    setupTimingPattern: function () {
      for (var a = 8; a < this.moduleCount - 8; a++) {
        this.modules[a][6] && (this.modules[a][6] = a % 2 === 0) === null;
      }
      for (a = 8; a < this.moduleCount - 8; a++) {
        this.modules[6][a] && (this.modules[6][a] = a % 2 === 0) === null;
      }
      ...
      for (var a = j.getPatternPosition(this.typeNumber), c = 0; c < a.length; c++) {
        for (var d = 0; d < a.length; d++) {
          ...
          if (this.modules[b][e] === null) {
            for (var f = -2; f <= 2; f++) {
              for (var i = -2; i <= 2; i++) {
                this.modules[b + f][e + i] = f === -2 || f === 2 || i === -2 || i === 2 || f === 0 && i === 0 ? !0 : !1
              }
            }
          }
        }
      ...
      for (d = 0; d < 18; d++)b = !a && 1 == (c >> d & 1), this.modules[d % 3 + this.moduleCount - 8 - 3][Math.floor(d / 3)] = b
    }, setupTypeInfo: function (a, c) {
      for (var d = j.getBCHTypeInfo(this.errorCorrectLevel << 3 | c), b = 0; 15 > b; b++) {
        var e = !a && 1 == (d >> b & 1);
        6 > b ? this.modules[b][8] = e : 8 > b ? this.modules[b + 1][8] = e : this.modules[this.moduleCount - 15 + b][8] = e
      }
      for (b = 0; b < 15; b++)e = !a && 1 == (d >> b & 1), 8 > b ? this.modules[8][this.moduleCount -
      ...
      for (var d = -1, b = this.moduleCount - 1, e = 7, f = 0, i = this.moduleCount - 1; 0 < i; i -= 2)for (6 == i && i--; ;) {
        for (var g = 0; g < 2; g++)if (null == this.modules[b][i - g]) {
          var n = !1;
  ...
  o.createData = function (a, c, d) {
    ...
    for (b.getLengthInBits() + 4 <= 8 * a && b.put(0, 4); b.getLengthInBits() % 8 !== 0;) {
      b.putBit(!1);
    }
  ...
  for (var j = {
    ...
    getLostPoint: function (a) {
      for (var c = a.getModuleCount(), d = 0, b = 0; b < c; b++) {
        for (var e = 0; e < c; e++) {
          for (var f = 0, i = a.isDark(b, e), g = -1; 1 >= g; g++) {
            if (!(b + g < 0 || c <= b + g)){
              for (var h = -1; h <= 1; h++){
                0 > e + h || c <= e + h || g ===  0 && h === 0 || i === a.isDark(b + g, e + h) && f++;
              }
            }
          }
          f > 5 && (d += 3 + f - 5)
      ...
      for (b = 0; b < c - 1; b++) {
        for (e = 0; e < c - 1; e++) {
          if (f = 0, a.isDark(b, e) && f++, a.isDark(b + 1, e) && f++, a.isDark(b, e + 1) && f++, a.isDark(b + 1, e + 1) && f++, f ==0 || f === 4) {
            d += 3;
          }
        }
      }
